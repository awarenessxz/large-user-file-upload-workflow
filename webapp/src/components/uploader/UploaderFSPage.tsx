    ...
    return (
        <React.Fragment>
            <header className="masthead">
                <Container>
                    <div className="mx-auto text-center">
                        <h1>{ Data.web_name }</h1>
                        <h3>Upload files workflow via File System</h3>
            ...
            <VerticallyCenteredModal
                title="Upload Files"
                content={<FileDropzone showUploads showConfigs uploadUrl={Data.api_endpoints.upload_files_fs} />}
                show={modalShow}
